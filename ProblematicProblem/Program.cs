...
namespace ProblematicProblem
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            //this quits out if they don't say yes
            ...
            bool seeList = Console.ReadLine() == "sure" || Console.ReadLine() == "yes" ? true : false ;
            if (seeList)
            {
            ...
            while (cont)
            {
                ...
                //to get set activity switch "activities[randomNumber]" to "Wine Tasting"
